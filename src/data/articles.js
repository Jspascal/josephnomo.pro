export const articlesData = [
  {
    ...
    date: "March 23, 2025",
    summary:
      "How to implement a robust event-driven architecture for microservices using Redis Streams and Laravel, with event tracking and replay capabilities.",
    tags: ["Microservices", "Redis", "Laravel", "Event-Driven"],
    image: "/queue-consumers.jpg",
    category: "Architecture",
    canonicalUrl:
      "https://josephnomo.pro/portfolio/redis-streams-microservices",
    author: {
      name: "Joseph Nomo",
...
This approach has significantly improved the reliability of GVEO's microservices ecosystem while reducing the operational burden of managing inter-service communication.
  ...
  },
  {
    ...
    date: "March 15, 2025",
    summary:
      "A case study on building efficient analytics for fleet management by consuming data from diverse services and creating denormalized spatial tables for high-performance queries.",
...
The spatial data approach has proven so successful that I've applied it to other analytics domains in the organization, creating a more resilient and performant system overall.
  ...
  },
  {
    ...
    date: "March 10, 2025",
    summary:
      "How to use the Strategy Pattern to create more flexible and maintainable event handling, subscribers, and notifications in Laravel applications.",
